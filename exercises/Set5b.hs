...
set [] _ Empty = Empty
set [] newVal (Node _ l r) = Node newVal l r
set _ _ Empty = Empty
set (StepL:steps) newVal (Node val l r) = Node val (set steps newVal l) r
set (StepR:steps) newVal (Node val l r) = Node val l (set steps newVal r)
